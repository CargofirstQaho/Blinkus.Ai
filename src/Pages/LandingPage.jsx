...
export default function LandingPage() {
  ...
  const openAuth = (tab) => {
    const resolvedTab = typeof tab === "string" && ["login", "register"].includes(tab) ? tab : "login"
    setAuthTab(resolvedTab)
    setAuthOpen(true)
  }
...
// const LOADED_KEY = "blinkus_loaded"

// export default function LandingPage() {
//   const [authOpen, setAuthOpen] = useState(false)
//   const [authTab, setAuthTab] = useState("login")
//   const [showLoader, setShowLoader] = useState(() => !sessionStorage.getItem(LOADED_KEY))
//   const location = useLocation()
...
//   const openAuth = (tab) => {
//     const t = typeof tab === "string" && ["login", "register"].includes(tab) ? tab : "login"
//     setAuthTab(t)
//     setAuthOpen(true)
//   }
