...
import { useState } from "react"
import { ArrowLeft, Bookmark, UserSearch, TrendingUp, Users, MapPin, Lock } from "lucide-react"
    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "#fff", fontFamily: "'DM Sans','Segoe UI',system-ui,sans-serif" }}>
      <style>{`
        ...
        @media (max-width: 640px) {
          ...
          .buyer-card { flex-direction: column !important; align-items: flex-start !important; }
        }
      ...
      <div className="feature-header" style={{ padding: "clamp(12px,3vw,20px) clamp(16px,4vw,24px)", borderBottom: "1px solid #f3f4f6", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: "clamp(8px,2vw,16px)", minWidth: 0, flex: 1 }}>
          ...
          <h1 style={{ fontSize: "clamp(14px,2.5vw,18px)", fontWeight: 700, color: NAVY, margin: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>Buyers & New Buyer Signals</h1>
        </div>
      ...
      <div style={{ flex: 1, overflowY: "auto", overflowX: "hidden" }}>
        <div className="feature-main-grid" style={{ display: "flex", gap: "clamp(16px,3vw,24px)", padding: "clamp(16px,3vw,24px)" }}>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ background: RED_BG, borderRadius: 16, padding: "clamp(16px,3vw,24px)", marginBottom: "clamp(16px,3vw,24px)", position: "relative" }}>
              <div style={{ position: "absolute", top: 16, right: 16, background: "#fff", padding: "6px 12px", borderRadius: 8, border: "1px solid #ffe4e6", display: "flex", alignItems: "center", gap: 6, zIndex: 1 }}>
                <Lock size={12} color="#6b7280" />
                <span style={{ fontSize: 11, fontWeight: 700, color: "#6b7280", letterSpacing: "0.05em" }}>COMING SOON</span>
              </div>
              <div style={{ display: "flex", alignItems: "flex-start", gap: 16, marginBottom: 16, flexWrap: "wrap" }}>
                <div style={{ width: 56, height: 56, borderRadius: 14, background: RED, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <UserSearch size={24} color="#fff" strokeWidth={2.5} />
                </div>
                <div style={{ flex: 1, minWidth: 200 }}>
                  <h2 style={{ fontSize: "clamp(17px,3vw,20px)", fontWeight: 800, color: NAVY, margin: "0 0 6px 0" }}>Buyers & New Buyer Signals</h2>
            ...
            <div className="metric-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 24 }}>
              {[
                ...
                <div key={i} style={{ background: "#fff", border: "1px solid #f3f4f6", borderRadius: 12, padding: "clamp(12px,2vw,16px)" }}>
                  ...
                  <div style={{ fontSize: 11, color: "#6b7280", marginBottom: 4, fontWeight: 600 }}>{metric.label}</div>
                  <div style={{ fontSize: "clamp(14px,2.5vw,16px)", fontWeight: 800, color: NAVY, marginBottom: 4 }}>{metric.value}</div>
                  <div style={{ fontSize: 10, fontWeight: 700, color: metric.change === "New" ? "#3b82f6" : metric.change.startsWith("+") ? "#22c55e" : "#f97316" }}>
                    {metric.change}
                  </div>
                </div>
            ...
            <div style={{ background: "#fff", border: "1px solid #f3f4f6", borderRadius: 12, padding: "clamp(16px,3vw,20px)" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexWrap: "wrap", gap: 12 }}>
                <h3 style={{ fontSize: "clamp(14px,2.5vw,15px)", fontWeight: 700, color: NAVY, margin: 0 }}>New Buyer Signals</h3>
                <button style={{ padding: "8px 16px", borderRadius: 8, background: "#3b82f6", color: "#fff", border: "none", fontSize: 12, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", gap: 6 }}>
                  <TrendingUp size={12} />
                  AI Analyze
                </button>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {buyerSignals.map((buyer, i) => (
                  <div key={i} style={{ background: "#fafafa", borderRadius: 12, padding: "clamp(12px,2vw,16px)", border: "1px solid #f3f4f6" }}>
                    <div className="buyer-card" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 10, gap: 12 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 12, minWidth: 0, flex: 1 }}>
                        <div style={{ width: 40, height: 40, borderRadius: 10, background: buyer.badge === "#22c55e" ? "#dcfce7" : "#fef3c7", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                          <Users size={18} color={buyer.badge} />
                        </div>
                        <div style={{ minWidth: 0, flex: 1 }}>
                          <div style={{ fontSize: "clamp(12px,2vw,13px)", fontWeight: 700, color: NAVY, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{buyer.company}</div>
                          <div style={{ fontSize: 11, color: "#6b7280", display: "flex", alignItems: "center", gap: 4 }}>
                            <MapPin size={10} />
                            {buyer.country}
                          </div>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 8, flexShrink: 0, flexWrap: "wrap", justifyContent: "flex-end" }}>
                        <span style={{ padding: "4px 10px", borderRadius: 6, background: buyer.badge === "#22c55e" ? "#dcfce7" : "#fef3c7", fontSize: 10, fontWeight: 700, color: buyer.badge, whiteSpace: "nowrap" }}>
                          {buyer.potential}
                        </span>
                        <div style={{ textAlign: "right" }}>
                          <div style={{ fontSize: 10, color: "#6b7280" }}>First Order</div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 12px", background: "#fff", borderRadius: 8, border: "1px solid #e5e7eb" }}>
                      ...
                      <span style={{ fontSize: "clamp(10px,1.8vw,11px)", color: "#6b7280", lineHeight: 1.4 }}>{buyer.insight}</span>
                    </div>
                  </div>
                ))}
              </div>
